...
local joker_basic_atlases = {"phantom_blood", "battle_tendency", "stardust_crusaders", "diamond_is_unbreakable", "golden_wind", "stone_ocean", "jojolion"} -- {"steel_ball_run", "the_jojolands", "others"}
