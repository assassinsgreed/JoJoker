...
local joker_basic_atlases = {"phantom_blood", "stardust_crusaders", "stone_ocean", "jojolion"} -- {"battle_tendency", "diamond_is_unbreakable", "golden_wind", "steel_ball_run", "the_jojolands", "others"}
