JokerSprites = {
    ...
    list = {
        ...
        {name = "dio_brando", base = {pos = {x = 0, y = 2}}, part_atlas = "phantom_blood" },
        ...
        {name = "suzi_q", base = {pos = {x = 2, y = 1}}, part_atlas = "battle_tendency" },
        {name = "nypd", base = {pos = {x = 3, y = 1}}, part_atlas = "battle_tendency" },
        ...
        {name = "ndoul", base = {pos = {x = 2, y = 0}}, part_atlas = "stardust_crusaders" },
        {name = "star_platinum", base = {pos = {x = 3, y = 0}}, part_atlas = "stardust_crusaders" },
        {name = "wheel_of_fortune", base = {pos = {x = 4, y = 0}}, part_atlas = "stardust_crusaders" },
        {name = "the_lovers", base = {pos = {x = 0, y = 1}}, part_atlas = "stardust_crusaders" },
        {name = "old_joseph_joestar", base = {pos = {x = 1, y = 1}}, part_atlas = "stardust_crusaders" },
        {name = "anubis", base = {pos = {x = 2, y = 1}}, part_atlas = "stardust_crusaders" },
        {name = "sethan", base = {pos = {x = 3, y = 1}}, part_atlas = "stardust_crusaders" },
        {name = "the_world", base = {pos = {x = 4, y = 1}}, part_atlas = "stardust_crusaders" },
        ...
        {name = "darby_brothers", base = {pos = {x = 4, y = 2}}, part_atlas = "stardust_crusaders" },
        {name = "hierophant_green", base = {pos = {x = 0, y = 3}}, part_atlas = "stardust_crusaders" },
        {name = "the_fool", base = {pos = {x = 1, y = 3}}, part_atlas = "stardust_crusaders" },
        {name = "thoth", base = {pos = {x = 2, y = 3}}, part_atlas = "stardust_crusaders" },
        ...
        {name = "the_hand", base = {pos = {x = 3, y = 0}}, part_atlas = "diamond_is_unbreakable" },
        {name = "superfly", base = {pos = {x = 4, y = 0}}, part_atlas = "diamond_is_unbreakable" },
        ...
        {name = "cinderella", base = {pos = {x = 4, y = 1}}, part_atlas = "diamond_is_unbreakable" },
        {name = "reimi", base = {pos = {x = 0, y = 2}}, part_atlas = "diamond_is_unbreakable" },
        {name = "atom_heart_father", base = {pos = {x = 1, y = 2}}, part_atlas = "diamond_is_unbreakable" },
        ...
        {name = "seven_page_muda", base = {pos = {x = 4, y = 2}}, part_atlas = "golden_wind" },
        -- Part 6: Stone Ocean
        ...
        {name = "pucci", base = {pos = {x = 3, y = 1}}, part_atlas = "stone_ocean" },
        ...
        {name = "c_moon", base = {pos = {x = 3, y = 2}}, part_atlas = "stone_ocean" },
        {name = "planet_waves", base = {pos = {x = 4, y = 2}}, part_atlas = "stone_ocean" },
        ...
        {name = "chocolate_disco", base = {pos = {x = 2, y = 0}}, part_atlas = "steel_ball_run" },
        {name = "oh_lonesome_me", base = {pos = {x = 3, y = 0}}, part_atlas = "steel_ball_run" },
        {name = "hey_ya", base = {pos = {x = 4, y = 0}}, part_atlas = "steel_ball_run" },
        {name = "tattoo_you", base = {pos = {x = 0, y = 1}}, part_atlas = "steel_ball_run" },
        {name = "danny_sbr", base = {pos = {x = 1, y = 1}}, part_atlas = "steel_ball_run" },
        {name = "turbo_eyes", base = {pos = {x = 2, y = 1}}, part_atlas = "steel_ball_run" },
        ...
        {name = "left_side_ataxia", base = {pos = {x = 1, y = 3}}, part_atlas = "steel_ball_run" },
        {name = "love_train", base = {pos = {x = 2, y = 3}}, part_atlas = "steel_ball_run" },
        {name = "in_a_silent_way", base = {pos = {x = 3, y = 3}}, part_atlas = "steel_ball_run" },
        {name = "sugar_mountain", base = {pos = {x = 4, y = 3}}, part_atlas = "steel_ball_run" },
        -- Part 8: Jojolion
        ...
        {name = "milagro_man", base = {pos = {x = 3, y = 0}}, part_atlas = "jojolion" },
        ...
        {name = "doctor_wu", base = {pos = {x = 3, y = 1}}, part_atlas = "jojolion" },
